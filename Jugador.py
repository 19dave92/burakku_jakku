...
class Jugador():
    ...
    def __init__(self, nombre, fichas=50, hand=[]):
        """
        nombre: string- Recibe el nombre del jugador.
        fichas: int- Cantidad de fichas con las que inicia un jugador nuevo.
        hand: list- Mano actual del jugador. Si es nuevo, su mano está vacía.
        """
